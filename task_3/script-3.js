...
while (condition); + prompt("Введите первое целое число");
...
// Задание №4.Необходимо реализовать четыре функции, каждая функция должна принимать по два
...
const numbers = +prompt('Введите второе целое число');
